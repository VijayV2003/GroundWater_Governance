...
async def send_email_updates():
    ...
    while True:
        ...
        message = Mail(
            ...
            subject='🔴 URGENT: Groundwater Security Alert',
            html_content='''<strong>Dear Policy Maker,</strong><br><br>
            Critical anomalies have been detected in the National DWLR Network.<br>
            Please check the Groundwater Intelligence Dashboard for immediate action.<br><br>
            <strong>System Status:</strong><br>
            - National Sustainability Index: 72%<br>
            - Active Alerts: 2 Critical<br>'''
        )
